...
export const Header = () => {
  return (
    <div className="w-full bg-basic-white">
      <div className="m-auto flex w-4/5 items-center justify-between py-5">
        ...
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            >
              <User color={styles.colors.basic.black} />
            </Link>
          ...
          <div className="flex items-center gap-5">
            <Link href={AppLink.WishList} className="relative">
              <HeartIcon />
              <div className="absolute -right-3 -top-3 flex size-6 items-center justify-center rounded-full border-2 border-basic-white bg-red-500">
                <span className="text-sm font-medium text-basic-white">0</span>
              </div>
            </Link>
